...
<html lang="en">
    ...
    <link rel="stylesheet" href="Admin/css/templatemo.css">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Danh sách sản phẩm| <a href="sanphamthemmoi.php">Thêm mới</a>|<a href="loaisanpham.php">Loại Sản Phẩm</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    ;?>
                                        <tr>
                                            ...
                                            <td><a href="sanphamsua.php?id=<?php echo $row["sp_id"];?>">Sửa</a></td>
                                            <td><a href="sanphamxoa.php?id=<?php echo $row["dm_id"];?>">Xóa</a></td>
                                        </tr>
                                    <?php
                                        }
                                    ;?>
